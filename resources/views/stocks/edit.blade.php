...
<div class="container">
    ...
    {{ Form::open(['url' => '/stocks/update']) }}
        ...
        <div class="form-group">
          ...
          @if ($errors->has('limit'))
          {{ Form::input('date', 'limit', $input['limit']?? '', ['class' => 'form-control is-invalid', 'id' => 'limit', 'placeholder' => 'input date.']) }}
          <div class="invalid-feedback">
            {{ $errors->first('limit') }}
          </div>
          @else
          {{ Form::input('date', 'limit', $input['limit']?? '', ['class' => 'form-control', 'id' => 'limit', 'placeholder' => 'input date.']) }}
          @endif
